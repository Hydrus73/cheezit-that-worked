...
public final class Constants {
     ...
     */
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = 0.5461; // FIXED Measure and set trackwidth
    /**
     * The front-to-back distance between the drivetrain wheels.
     *
     * Should be measured from center to center.
     */
    public static final double DRIVETRAIN_WHEELBASE_METERS = 0.5461; // FIXED Measure and set wheelbase


    public static final int FRONT_LEFT_MODULE_DRIVE_MOTOR = 3; // FIXED Set front left module drive motor ID
    public static final int FRONT_LEFT_MODULE_STEER_MOTOR = 4; // FIXED Set front left module steer motor ID
    ...
    public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 6; // FIXED Set front right drive motor ID
    public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 5; // FIXED Set front right steer motor ID
    ...
    public static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 8; // FIXED Set back left drive motor ID
    public static final int BACK_LEFT_MODULE_STEER_MOTOR = 7; // FIXED Set back left steer motor ID
    ...
    public static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 2; // FIXED Set back right drive motor ID
    public static final int BACK_RIGHT_MODULE_STEER_MOTOR = 1; // FIXED Set back right steer motor ID
